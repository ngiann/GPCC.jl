...
```
"""
function performcv(tobs, yobs, σobs; delays = delays, iterations = 1, seedcv = 1, kernel::AbstractKernelFunction = kernel, numberofrestarts = 1, numberoffolds = 5, plotting = false, rhomin = 0.1, rhomax = 20.0)
